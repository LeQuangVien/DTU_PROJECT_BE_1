...
class ChiiTietDonHangController extends Controller
{
    public function themVaoGioHang(Request $request)
    {
        ...
        if ($sanpham) {
            ...
            if ($tim) {
                ...
                $tim->tong_khuyen_mai = $tim->thanh_tien - $tim->so_luong * 100000;
                $tim->save();
            } else {
                ChiiTietDonHang::create([
                    ...
                    'don_gia'           => $dongia,
                    'thanh_tien'        => $dongia * 1,
                    'tong_khuyen_mai'   => $tong
                    // 'tong_khuyen_mai'   => $tong_khuyen_mai,
                ]);
            }
    ...
    public function selectGioHang()
    {
        ...
        $data = ChiiTietDonHang::where('id_khach_hang', $khachhang->id)
            ...
            ->select('san_phams.hinh_anh', 'san_phams.ten_san_pham', 'san_phams.gia_khuyen_mai', 'chii_tiet_don_hangs.*')
    ...
    public function updateGioHang(Request $request)
    {
        ...
        if ($giohang) {
            ...
            $giohang->tong_khuyen_mai = $request->tong_khuyen_mai;
            $giohang->save();
            return response()->json([
                'status' => true,
