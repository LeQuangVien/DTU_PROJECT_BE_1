...
class DonHangController extends Controller
{
    public function dathang(Request $request)
    {
        ...
        $dia_chi = DiaChi::where('id_khach_hang', $khach_hang->id)->first();
        $diachi = DiaChi::where('id_khach_hang', $khach_hang->id)->where('id', $request->id_dia_chi)->first();
        if (!$dia_chi) {
            ...
            $don_hang = DonHang::create([
                ...
                'dia_chi_giao_hang'         => $diachi->dia_chi,
