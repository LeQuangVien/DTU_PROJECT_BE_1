...
Route::post('/gio-hang/delete/thanh-toan', [ChiiTietDonHangController::class, 'deleteThanhToan']);

//DiaChi
Route::post('dia-chi/Khach-Hang/tao-dia-chi-dat-hang', [DiaChiController::class, 'diachiDonHang']);

//DonHang
Route::post('khach-hang/don-hang/thanh-toan', [DiaChiCodOntroller::class, 'diachiDonHang']);
